<?php
    ...
    if (isset($_POST['forgot_password'])) {
        ...
        $emailCheckQuery = "SELECT * FROM admins WHERE admin_email = '$email'";
        ...
        if ($emailCheckResult) {
            ...
            if (mysqli_num_rows($emailCheckResult) > 0) {
                ...
                $updateQuery = "UPDATE admins SET code = $code WHERE admin_email = '$email'";
                $updateResult = mysqli_query($conn, $updateQuery);
                if ($updateResult) {
                    $subject = "Email Verification Code";
                    $message = "Your verification code is $code";
                    $sender = "From: michaelnjoroge2000@gmail.com";
