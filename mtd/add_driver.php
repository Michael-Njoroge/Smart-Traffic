                    ...
                    <form action="add_driver_action" method="POST">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                $licenseid = substr(str_shuffle($set), 0, 8);
                                ?>                        
                                 
                                <input type="text" class="form-control" id="license_id" name="licenseid" placeholder="License ID" value="<?php echo ($licenseid) ?>" disabled ><br>
